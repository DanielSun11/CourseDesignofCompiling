...
public class MainComplier extends JFrame {
    ...
    JButton jButton3 = new JButton("LL1文法1");
    JButton jButton4 = new JButton("LL1文法2");
    JButton jButton5 = new JButton("LL1文法3");
    JButton jButton6 = new JButton("LL1文法4");
    JButton jButton7 = new JButton("LR0文法");

    JLabel inLabel = new JLabel("待分析文件");
    JLabel outLabel = new JLabel("分析结果");
    ReadText readText = new ReadText(7, 90);//输入区
    OutText outText = new OutText(30, 90);//输出区
